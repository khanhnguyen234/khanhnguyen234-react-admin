...
import useRoute from '@khanhnguyen234/react-core/src/hooks/useRoute';
import ProductForm from './components/product-form';
import useProduct from './hooks/use-product';
import {
  requestApiAction,
  STATUS,
} from '@khanhnguyen234/react-common/src/utils/fetcher';
import { actionType } from './dataSrc';
import { useDispatch } from 'react-redux';
import { FORM_PROPS } from './const';
import { datetimeLocalToUnix } from '@khanhnguyen234/react-common/src/utils/date';
import { CONFIG } from '@khanhnguyen234/react-common/src/lib/const';
